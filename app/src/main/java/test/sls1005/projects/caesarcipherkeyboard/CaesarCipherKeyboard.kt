...
class CaesarCipherKeyboard : InputMethodService() {
    ...
    val digitKeys = intArrayOf(R.id.key_0, R.id.key_1, R.id.key_2, R.id.key_3, R.id.key_4, R.id.key_5, R.id.key_6, R.id.key_7, R.id.key_8, R.id.key_9)
    ...
    override fun onCreateInputView(): View {
        val keyCodeKeys = intArrayOf(R.id.key_backspace, R.id.key_enter)
        val unrotatedKeys = intArrayOf(R.id.key_comma, R.id.key_space, R.id.key_period)
        ...
        for (id in keyCodeKeys + R.id.key_upper) {
